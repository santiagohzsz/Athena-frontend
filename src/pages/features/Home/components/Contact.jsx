...
function Contact() {
    return (
        <>
        <div className="contact-container w-full flex flex-col gap-2 items-center h-auto py-20 bg-sky-500">
            ...
            <div className="contact-form w-3xl bg-white rounded-xl p-4">
