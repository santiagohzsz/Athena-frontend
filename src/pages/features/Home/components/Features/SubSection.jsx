...
function SubSection({ title, description, options, image, className }) {
    return (
        <>
        <div className={`subsection w-6xl max-xl:w-full max-lg:flex-col flex items-center justify-between gap-12 ${className}`}>
            <div className="subsection-left w-[90%] mx-auto flex flex-col gap-6">
            ...
            <div className="subsection-right w-[90%] border border-sky-500 h-100 rounded-lg">
